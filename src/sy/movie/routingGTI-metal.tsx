...
export class ParamComp extends React.PureComponent<ParamProps, ParamState> {
    ...
    listeProcess = [{"id" : 1, "text": "COMS"}, {"id" : 2, "text": "ESN"}, {"id" : 3, "text": "Bibliothèque"}, {"id" : 4, "text": "METALLISATION"}]     // A aller chercher en BDD
    ...
    requestData (): void {
        ...
        Common.postAsJson(url_, {process:"METALLISATION", authorization:"RoutingGTI:DISPLAY"}, this.receiveData.bind(this), this.receiveDataError.bind(this));
	}
		...
		return (
			<Page title={title}>
				<Toolbar>
                    ...
                    <ProcessTabsMetal activeTab={MetalTabs.ROUTINGGTI} />
				</Toolbar>
...
export const RoutingGTIMetal = Store.withStore(ParamComp);
