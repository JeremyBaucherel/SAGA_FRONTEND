...
export class ParamComp extends React.PureComponent<ParamProps, ParamState> {
    ...
    requestData (): void {
        ...
        Common.postAsJson(url_, {process:"ALL", authorization:"RoutingGTI:DISPLAY"}, this.receiveData.bind(this), this.receiveDataError.bind(this));
	}
...
export const RoutingGTI = Store.withStore(ParamComp);
