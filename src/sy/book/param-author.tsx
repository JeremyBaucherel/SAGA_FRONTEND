...
export class ParamComp extends React.PureComponent<ParamProps,ParamState> {
    ...
    requestListeJob (): void {
        ...
        Common.postAsJson(url_, {authorization:"BOOK:DISPLAY"}, this.receiveDataListeJob.bind(this), this.receiveDataListeJobError.bind(this));
	}
	...
	render (): React.ReactNode {
		...
		let col = [
			...
			new SpreadsheetColumn('name_job', 'Nom du métier', 500, "menu", "liste", true, true, true, true, true, this.state.resultListeJob, true),
		];
